...
namespace TeduCoreApp.Areas.Admin.Controllers
{
    public class ProductController : BaseController
    {
        ...
        public ProductController(IProductService productService, IProductCategoryService productCategoryService, IWebHostEnvironment hostingEnvironment)
        {
        ...
        public async Task<IActionResult> ExportExcel()
        {
            ...
            using (ExcelPackage package = new ExcelPackage(file))
            {
                ...
                var range = worksheet.SelectedRange["A1:V1"];
                range.Style.Fill.PatternType = ExcelFillStyle.Solid;
                range.Style.Fill.BackgroundColor.SetColor(Color.Red);
                worksheet.Cells["A1"].LoadFromCollection(products, true, TableStyles.Light8);
