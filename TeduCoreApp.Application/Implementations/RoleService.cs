...
namespace TeduCoreApp.Application.Implementations
{
    public class RoleService : IRoleService
    {
        ...
        public RoleService(RoleManager<AppRole> roleManager, IFunctionRepository functionRepository,
            IPermissionRepository permissionRepository, IUnitOfWork unitOfWork, IMapper mapper)
        {
